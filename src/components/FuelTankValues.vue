<template>
  <div>
    <b-card
        ...
        class="mb-1">
        <b-form-group class="mb-1" id="value-dip" label-for="value-dip">
            <b-form-input size="sm" id="value-dip" v-model="lDipValue" type="number" min="0" max="12" step="0.5" v-bind:value="value" v-on:input="$emit('input', volumeForDip)"
number></b-form-input>
        </b-form-group>

        <b-form-group class="mb-1" id="value-volume" label-for="value-volume">
            <b-form-input size="sm" id="value-volume" 
            v-model="volumeForDipStr"  
            disabled></b-form-input>
        </b-form-group>

        <b-form-group class="mb-1" id="timer-endurance" label-for="timer-endurance">
            <b-form-timepicker
                size="sm"
                id="timer-endurance"
                v-model="endurance"
